...
//om te compilen= g++ halftones.cpp -o halftones `pkg-config --cflags --libs opencv`
// om te runnen ./halftones --halftone 02.png 
int main(int argc, char *argv[])
{
    ...
    imwrite("target-image-output.jpg", target_image);
